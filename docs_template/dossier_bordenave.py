...
Prospect : Nicolas Bordenave — Plaquiste-jointeur RGE (Le Fossat, 09130)
"""
...
contenu = [
    ...
    Paragraph(
        "Vous avez déjà un site, plaquiste-ariege.com : cinq prestations bien "
        "présentées (bande à joint, pose de plaques de plâtre, isolation par "
        "l'intérieur, cloisons/doublage, plafonds décoratifs), une galerie de "
        "réalisations et un blog. Mais tout passe par un formulaire de contact "
        "ou le téléphone — et vous êtes sur les chantiers du lundi au samedi, "
        "7h-19h. Un visiteur qui a une question un soir, un dimanche, ou "
        "pendant que vous êtes en plein doublage, n'a personne pour lui "
        "répondre tout de suite : ni FAQ, ni tarifs indicatifs, ni prise de "
        "rendez-vous en ligne sur le site.",
        S["corps"]
    ),
    Spacer(1, 4*mm),
    ...
    Paragraph(
        ...
        "zone d'intervention (Le Fossat, Pamiers, Foix, Muret...), délais "
        "habituels, déroulé d'une demande de devis, éligibilité aux aides "
        "RGE pour l'isolation. Il qualifie la demande avant qu'elle arrive "
    ...
    Paragraph(
        ...
        "(prestations, zone d'intervention, horaires, aides RGE) et oriente "
        "vers vous pour tout devis précis — sans jamais inventer d'information.",
        S["corps"]
    ),
    Paragraph(
        "● Vous gardez la main : le contenu est configuré avec vous, à partir "
        "de ce que vous savez de votre activité — pas d'un paramétrage "
        "générique.",
        S["corps"]
    ),
    Spacer(1, 4*mm),
    ...
    Paragraph("3. Intégration sur plaquiste-ariege.com", S["corps"]),
...
if __name__ == "__main__":
    build_document(
        output_path="C:/Projets/mp-solutions-ia/docs_template/dossier_bordenave.pdf",
        title="Dossier de présentation",
        subtitle="Prospect : Nicolas Bordenave — Plaquiste-jointeur RGE",
