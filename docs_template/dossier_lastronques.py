...
Prospect : Domaine de Lastronques (Lézat-sur-Lèze, 09210)
"""
...
contenu = [
    ...
    Paragraph(
        "Votre site, domainedelastronques.fr, présente bien vos vins, la "
        "vente directe et vos événements (guinguettes, raclettes) — le "
        "contenu est à jour et bien tenu. Mais pour toute question — "
        "dégustation en dehors du samedi matin, visite de groupe, "
        "disponibilité d'une cuvée avant un événement — il n'y a ni "
        "formulaire de contact, ni FAQ. Un visiteur qui hésite doit "
        "attendre le samedi ou passer par les réseaux sociaux.",
        S["corps"]
    ),
    Spacer(1, 4*mm),
    ...
    Paragraph(
        ...
        "horaires de vente directe, prise de rendez-vous pour une visite "
        "ou une dégustation de groupe, cépages et cuvées disponibles, "
        "dates des prochaines guinguettes. Il qualifie la demande avant "
        "qu'elle arrive jusqu'à vous et vous transmet les demandes "
        "sérieuses.",
        S["corps"]
    ),
    Spacer(1, 5*mm),
    ...
    Paragraph(
        ...
        "(horaires, cuvées, événements, visites) et oriente vers vous pour "
        "toute réservation précise — sans jamais inventer d'information.",
        S["corps"]
    ),
    Paragraph(
    ...
    Paragraph("3. Intégration sur domainedelastronques.fr", S["corps"]),
...
if __name__ == "__main__":
    build_document(
        output_path="C:/Projets/mp-solutions-ia/docs_template/dossier_lastronques.pdf",
        title="Dossier de présentation",
        subtitle="Prospect : Domaine de Lastronques",
