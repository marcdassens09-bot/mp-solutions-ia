...
Prospect : Bois Ariégeois et Charpentes (Saint-Paul-de-Jarrat, 09000)
"""
...
contenu = [
    ...
    Paragraph(
        "Vous avez quatre métiers bien distincts — sciage, emballage bois "
        "industriel, charpente, terrasses bois — nés de la fusion de trois "
        "entreprises au sein du groupe Bois Génération Avenir. Mais votre "
        "adresse web officielle, groupebga.fr, redirige aujourd'hui vers une "
        "page vitrine générique PagesJaunes, sans détail sur vos métiers, "
        "sans FAQ, sans formulaire. Concrètement, vous n'avez aucune "
        "présence en ligne qui explique ce que vous faites réellement : ni à "
        "un particulier qui veut une terrasse bois, ni à une entreprise du "
        "bâtiment qui cherche une charpente ou un fournisseur d'emballage.",
        S["corps"]
    ),
    Spacer(1, 4*mm),
    ...
    Paragraph(
        ...
        "commençant par un chatbot installé sur une page dédiée, qui "
        "présente enfin vos quatre métiers et oriente chaque visiteur vers "
        "le bon : particulier pour une terrasse, professionnel du bâtiment "
        "pour une charpente, industriel pour l'emballage bois. Il répond "
        "aux questions courantes — capacité de stockage, certification "
        "PEFC, délais — et vous transmet uniquement les demandes "
        "qualifiées, avec la possibilité d'ajouter ensuite un suivi "
        "automatique de ces demandes.",
        S["corps"]
    ),
    Paragraph(
        "Si vous préférez un vrai site plutôt qu'une page dédiée simple, "
    ...
    Paragraph(
        ...
        "à partir des informations réelles de votre activité (métiers, "
        "certification PEFC, capacité de stockage, délais) et oriente vers "
        "vous pour toute demande précise — sans jamais inventer "
        "d'information.",
        S["corps"]
    ),
    Paragraph(
    ...
    Paragraph("1. Questionnaire technique (horaires, métiers, FAQ, ton souhaité)", S["corps"]),
    Paragraph("2. Configuration du chatbot", S["corps"]),
    Paragraph("3. Intégration sur une page web dédiée (à créer, faute de site actuel)", S["corps"]),
...
if __name__ == "__main__":
    build_document(
        output_path="C:/Projets/mp-solutions-ia/docs_template/dossier_bois_ariegeois.pdf",
        title="Dossier de présentation",
        subtitle="Prospect : Bois Ariégeois et Charpentes — Sciage, emballage, charpente, terrasses bois",
