...
Prospect : La Cantine du Prieuré — SARL La Commanderie (Lézat-sur-Lèze, 09210)
"""
...
contenu = [
    ...
    Paragraph(
        "Vous avez déjà un site, lacantineduprieure.fr : horaires, tarifs "
        "(20€ le midi en semaine, 40€ le week-end), coordonnées et un menu "
        "en PDF. Mais pour toute question — une table dispo ce soir, un menu "
        "sans gluten, si vous prenez les groupes — il n'y a qu'un formulaire "
        "de contact générique ou le téléphone, aux heures de service. Pas de "
        "FAQ, pas de prise de réservation en ligne : un visiteur qui hésite "
        "un dimanche soir n'a personne pour lui répondre tout de suite.",
        S["corps"]
    ),
    Spacer(1, 4*mm),
    ...
    Paragraph(
        ...
        "horaires d'ouverture, tarifs, menu du jour, groupes, allergènes, "
        "comment réserver. Il qualifie la demande avant qu'elle arrive "
        "jusqu'à vous et vous transmet uniquement les demandes de "
        "réservation sérieuses.",
        S["corps"]
    ),
    Spacer(1, 5*mm),
    ...
    Paragraph(
        ...
        "(horaires, tarifs, menu, groupes) et oriente vers vous pour toute "
        "réservation ferme — sans jamais inventer d'information.",
        S["corps"]
    ),
    Paragraph(
    ...
    Paragraph("1. Questionnaire technique (horaires, menu, FAQ, ton souhaité)", S["corps"]),
    Paragraph("2. Configuration du chatbot", S["corps"]),
    Paragraph("3. Intégration sur lacantineduprieure.fr", S["corps"]),
...
if __name__ == "__main__":
    build_document(
        output_path="C:/Projets/mp-solutions-ia/docs_template/dossier_cantine.pdf",
        title="Dossier de présentation",
        subtitle="Prospect : La Cantine du Prieuré (SARL La Commanderie)",
