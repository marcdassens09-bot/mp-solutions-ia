...
Prospect : Loïc Claustre — Plombier-chauffagiste RGE/QualiPac (Le Mas-d'Azil, 09290)
"""
...
contenu = [
    ...
    Paragraph(
        "Vous êtes installé au Mas-d'Azil depuis 2013, certifié QualiPac "
        "pour les pompes à chaleur — un vrai savoir-faire reconnu. Mais "
        "aucun site internet dédié à votre activité n'existe aujourd'hui : "
        "on ne vous trouve que dans des annuaires génériques (PagesJaunes, "
        "Kompass...), pas de page où un client peut voir vos prestations, "
        "vous contacter directement ou poser une question en dehors de vos "
        "horaires d'intervention. Votre activité repose sur le "
        "bouche-à-oreille — solide, mais ça laisse passer les clients qui "
        "cherchent d'abord en ligne.",
        S["corps"]
    ),
    Spacer(1, 4*mm),
    ...
    Paragraph(
        ...
        "optimisée pour que vous apparaissiez quand on cherche un "
        "plombier-chauffagiste près de chez soi. Le chatbot répond à toute "
        "heure aux questions qui reviennent tout le temps : zone "
        "d'intervention, délais, devis, aides RGE/MaPrimeRénov' pour les "
        "pompes à chaleur. Il qualifie la demande avant qu'elle arrive "
    ...
    Paragraph(
        "● Un visiteur cherche un plombier-chauffagiste près de chez lui, "
...
if __name__ == "__main__":
    build_document(
        output_path="C:/Projets/mp-solutions-ia/docs_template/dossier_claustre.pdf",
        title="Dossier de présentation",
        subtitle="Prospect : Loïc Claustre — Plombier-chauffagiste (Le Mas-d'Azil, 09290)",
