...
Prospect : Cler Verts (Bélesta-en-Lauragais, 31540)
"""
...
contenu = [
    ...
    Paragraph(
        "Votre site cler-verts.fr présente clairement vos deux grandes offres "
        "— EcoResto® pour la restauration et EcoDistri® pour la grande "
        "distribution et la logistique — en plus de vos services pour les "
        "artisans, les particuliers en déchetterie et l'industriel. C'est "
        "rare d'avoir un discours aussi bien structuré par segment. Mais "
        "aucune FAQ, aucun outil qui aide un visiteur à savoir tout de suite "
        "à quelle offre il correspond : un restaurateur, une enseigne de "
        "GMS et un artisan qui arrivent sur le site doivent chacun chercher "
        "ou vous appeler pour se situer.",
        S["corps"]
    ),
    Spacer(1, 4*mm),
    ...
    Paragraph(
        ...
        "existant, qui oriente immédiatement chaque visiteur vers la bonne "
        "offre — EcoResto, EcoDistri, service artisan, déchetterie "
        "particulier ou plaquettes industrielles — et répond aux questions "
        "qui reviennent tout le temps sur chacune : tonnages acceptés, "
        "horaires, zone d'intervention. Il qualifie la demande avant "
        "qu'elle arrive jusqu'à vous.",
        S["corps"]
    ),
    Spacer(1, 5*mm),
    ...
    Paragraph(
        ...
        "(offres EcoResto/EcoDistri, tonnages, horaires, zone "
        "d'intervention) et oriente vers vous pour tout devis précis — sans "
    ...
    Paragraph("1. Questionnaire technique (horaires, offres, FAQ, ton souhaité)", S["corps"]),
    Paragraph("2. Configuration du chatbot", S["corps"]),
    Paragraph("3. Intégration sur cler-verts.fr", S["corps"]),
...
if __name__ == "__main__":
    build_document(
        output_path="C:/Projets/mp-solutions-ia/docs_template/dossier_cler_verts.pdf",
        title="Dossier de présentation",
        subtitle="Prospect : Cler Verts — Compostage, méthanisation, recyclage bois",
